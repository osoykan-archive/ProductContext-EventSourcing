...
namespace Projac.Connector.NetCore.Testing
{
    /// <summary>
    ...
    public struct VerificationResult : IEquatable<VerificationResult>
    {
        ...
        /// <summary>
        ///     Returns a message stating why the test specification verification passed or failed, or an empty if it wasn't
        ///     specified.
        /// </summary>
        ...
        {
            return _state == other._state && string.Equals(Message, other.Message);
        }
        ...
        {
            return _state.GetHashCode() ^ Message.GetHashCode();
        }
