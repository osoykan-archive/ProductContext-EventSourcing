...
namespace Projac.Connector.NetCore
{
    ...
    public class AnonymousConnectedProjection<TConnection> : IEnumerable<ConnectedProjectionHandler<TConnection>>
    {
        ...
        /// </summary>
        /// <returns>
        ///     An <see cref="ConnectedProjectionHandlerEnumerator{TConnection}" /> that can be used to iterate through the
        ///     collection.
        /// </returns>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="AnonymousConnectedProjection{TConnection}" /> to
        ///     <see>
        ///         <cref>ConnectedProjectionHandler{TConnection}</cref>
        ///     </see>
        ///     .
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        ///     An <see cref="ConnectedProjectionHandlerEnumerator{TConnection}" /> that can be used to iterate through a copy of
        ///     the handlers.
        /// </returns>
